...
#cluster_and_plot(df, cols, 3, 'library_studyroom_museum_spaces')
...
#df = pd.read_csv('../../data/Processed/clustering/clustered_library_studyroom_museum_spaces.csv')
...
#df.to_csv('../../data/Processed/clustering/labled/labled_library_studyroom_museum_spaces.csv', index=False)
