...
df = pd.read_csv('../../data/Processed/neighbourhood/2021_accidents.csv')
...
cluster_and_plot(df, cols, 7, '2021_accidents')
...
#df = pd.read_csv('../../data/Processed/clustering/clustered_2021_accidents.csv')

# Here 0 means low, 1 means medium and 2 means high
#df['label'] = df['cluster'].map({1: 0, 3: 1, 5: 2, 0:3, 4:4, 2:5, 6:6})
...
#df.to_csv('../../data/Processed/clustering/labled/labled_2021_accidents.csv', index=False)
