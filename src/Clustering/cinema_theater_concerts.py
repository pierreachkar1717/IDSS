...
df = pd.read_csv('../../data/Processed/neighbourhood/cinema_theater_concerts_neighbourhood.csv')

# Choose the column/columns in your data that you want to use for clustering
cols = ['cinema_theater_concerts']
...
#cluster_and_plot(df, cols, 2, 'cinema_theater_concerts')
...
df = pd.read_csv('../../data/Processed/clustering/clustered_cinema_theater_concerts.csv')
...
df.to_csv('../../data/Processed/clustering/labled/labled_cinema_theater_concerts.csv', index=False)
