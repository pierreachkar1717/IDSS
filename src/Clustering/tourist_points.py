...
df = pd.read_csv('../../data/Processed/neighbourhood/tourist_points_neighbourhood.csv')

# Choose the column/columns in your data that you want to use for clustering
cols = ['tourists_points']
...
cluster_and_plot(df, cols, 3, 'tourists_points')
...
df.to_csv('../../data/Processed/clustering/labled/labeled_tourists_points.csv', index=False)
