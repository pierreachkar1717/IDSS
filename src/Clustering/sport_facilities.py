...
df = pd.read_csv('../../data/Processed/neighbourhood/sport_facilities_neighbourhood.csv')

# Choose the column/columns in your data that you want to use for clustering
cols = ['sport_facilities']
...
#optimal_clusters_number(df, cols, 20) # 15 clusters

#Second: Call the cluster_and_plot function to cluster your data and plot the results
#cluster_and_plot(df, cols, 15, 'sport_facilities')
...
df = pd.read_csv('../../data/Processed/clustering/clustered_sport_facilities.csv')
