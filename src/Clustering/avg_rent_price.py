...
#df = pd.read_csv('../../data/Processed/neighbourhood/avg_rent_price_2021_neighbourhood.csv')
...
#cluster_and_plot(df, cols, 2, 'price')
...
#df = pd.read_csv('../../data/Processed/clustering/clustered_price.csv')
...
#df.to_csv('../../data/Processed/clustering/labled/labled_price.csv', index=False)
