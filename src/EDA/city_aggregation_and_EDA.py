...
if __name__ == '__main__':
    aggregate_by_district('/data/Population/2022_avg_occup_homes.csv',
                          '/data/Processed/2021_incidents_gestionats_gub_district.csv', '2021_incidents_gestionats_gub')
    aggregate_by_neighbourhood('/data/Population/2022_avg_occup_homes.csv',
                               '/data/Processed/2021_incidents_gestionats_gub_neighbourhood.csv', '2021_incidents_gestionats_gub')
